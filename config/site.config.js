...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'nuub@vxcp2.onmicrosoft.com',
  ...
  secretKey: process.env.SECRET_KEY || 'onedrive-vercel-index',
}
